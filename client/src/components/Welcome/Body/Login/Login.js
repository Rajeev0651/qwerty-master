                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className='form-group col-10 mb-1'>
                        ...
                        {formik.errors.loginemail && formik.touched.loginemail ?
                            (<div className='error'>{formik.errors.loginemail}</div>): null }
                    </div>
                    <div className='form-group col-10'>
                        ...
                        <input
                            ...
                            {formik.errors.loginpassword && formik.touched.loginpassword?
                                (<div className='error'>{formik.errors.loginpassword}</div>):null }
                        <small><a href='/'>Forgot Password?</a></small>
                    </div>
                    <div className='form-group mb-0' align='center'>
                        <button 
                            className='btn btn-success btn-block col-4'
                            type='submit'
                            >
                            Login
                        </button>
