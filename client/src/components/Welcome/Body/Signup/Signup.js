    ...
    return (
        ...
        {route && <Redirect to={{pathname:'/home'}}/>}
            ...
            <div className='media-buttons'>
                <div className='mr-3'>
                    <button className='btn btn-md btn-danger'>continue with<br />
                        <i className="fa fa-google" aria-hidden="true">
                        </i> <b>Google</b>
                    </button>
                </div>
                <div className='mr-3'>
                    <button className='btn btn-md btn-primary'>continue with<br /><i
                        className="fa fa-facebook-official"
                        aria-hidden="true"></i> <b> facebook</b>
                    </button>
                </div>
                <div>
                    <button className='btn btn-md btn-info'>continue with<br />
